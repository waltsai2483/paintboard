...
## UI Design
<img alt="Preview" src="assets/markdown/ui-design.png" style="width: 100%;">
...
<img alt="Preview" src="assets/markdown/properties.png" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;"><br>
...
<br>
<img alt="Preview" src="assets/markdown/hand.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;">

### 抓取工具
* 按下**工具列**上的 手掌按鈕 或 <kbd>數字鍵1</kbd> 以切換為 抓取模式
    * 拖動以調整選擇圖層的位置

<img alt="Preview" src="assets/markdown/pen-erase.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;">
...
<br>
<img alt="Preview" src="assets/markdown/text.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;">
...
<br><img alt="Preview" src="assets/markdown/circle.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;">

* **圓形模式**: 按下 圓形按鈕 或 <kbd>數字鍵5</kbd> 以繪製橢圓形
  * 按下 <kbd>Shift</kbd> 以改為繪製正圓形

<br><img alt="Preview" src="assets/markdown/line.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;">

* **直線模式**: 按下 直線按鈕 或 <kbd>數字鍵6</kbd> 以繪製直線
  * 按下 <kbd>Shift</kbd> 以改為繪製水平/垂直線或45度斜線 (根據滑鼠位置調整角度) 

<br><img alt="Preview" src="assets/markdown/rect.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;">

* **方形模式**: 按下 方形按鈕 或 <kbd>數字鍵7</kbd> 以繪製矩形
  * 按下 <kbd>Shift</kbd> 以改為繪製正方形

<br><img alt="Preview" src="assets/markdown/trig.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;">

* **三角模式**: 按下 三角按鈕 或 <kbd>數字鍵8</kbd> 以繪製三角形
  * 按下 <kbd>Shift</kbd> 以改為繪製長寬相等的三角形

## Layer
<img alt="Preview" src="assets/markdown/layer.gif" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;"><br>
...
<img alt="Preview" src="assets/markdown/control.png" style="width: 100%; box-shadow: 0px 0px 5px 0.25px #dddddd;"><br>
